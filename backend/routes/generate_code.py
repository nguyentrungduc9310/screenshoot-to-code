    ...
    if SHOULD_MOCK_AI_RESPONSE:
        ...
        try:
            ...
            if openai_api_key and anthropic_api_key:
                variant_models = [claude_model, Llm.GPT_4O_2024_11_20]
            elif openai_api_key:
                variant_models = [Llm.GPT_4O_2024_11_20, Llm.GPT_4O_2024_11_20]
            elif anthropic_api_key:
                variant_models = [claude_model, Llm.CLAUDE_3_5_SONNET_2024_06_20]
            else:
                await throw_error(
                    "No OpenAI or Anthropic API key found. Please add the appropriate API key in the settings dialog or backend/.env."
                )
                raise Exception("No OpenAI or Anthropic key")

            tasks: List[Coroutine[Any, Any, Completion]] = []
            for index, model in enumerate(variant_models):
                if model in (Llm.GPT_4O_2024_11_20, Llm.O1_2024_12_17):
